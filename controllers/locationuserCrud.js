...
var updateOrCreate = ((username, locationName) => {
          ...
          resUser.save((err, updatedUser) => {
            location.findOne({name:locationName}, (err, resLocation) => {
              ...
              resLocation.save((err, updatedLoc) => {
                console.log(err ? err : `User and location are updated`);
              });
            });
          });
        }
            ...
            location.findOne({name:locationName}, (err, resLocation) => {
              if(resLocation) {
                ...
                newLocation.save((err, createdLoc) => {
                  console.log(err ? err : `User is updated and location is created`);
                });
              }
            });
          });
        ...
        newUser.save((err, createdUser) => {
          ...
          location.findOne({name:locationName}, (err, resLocation) => {
            ...
            if (resLocation){
              ...
              resLocation.users.push(username);
              resLocation.save((err, updatedLoc) => {
                console.log(err ? err : `User is created and location is updated`);
              });
            }
            ...
            // can't find the location
              ...
              newLocation.save((err, createdLocation) => {
                console.log(err ? err : `User and location are created`);
              });
            }
          });
        });
